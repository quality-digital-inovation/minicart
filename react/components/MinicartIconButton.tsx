...
const MinicartIconButton: React.FC<Props> = props => {
  ...
  const openMinicartLabel = intl.formatMessage({
  ...
  return (
    <button
      type="button"
      aria-label={openMinicartLabel}
      className="vtex-button bw1 ba fw5 v-mid relative pa0 lh-solid br2 min-h-regular t-action bg-transparent b--transparent c-action-primary pointer bn"
      onMouseEnter={
        openBehavior === 'hover'
